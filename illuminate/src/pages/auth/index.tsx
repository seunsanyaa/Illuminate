      ...
      <div className="flex min-h-full justify-center">
              ...
              <div className="mt-10">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm font-medium leading-6">
                    <span
                      className="bg-white px-6 text-white"
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  <a
                    href="#"
                    className="flex w-full items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:ring-transparent"
                  >
                    <svg
                      className="h-5 w-5"
                      aria-hidden="true"
        ...
        <div className="w-1/3 h-full">
          <Image
            ...
            height={292}
            src={
              "https://res.cloudinary.com/seunsanyaa/image/upload/v1715863553/Rectangle_48_oerboo.png"
            }
