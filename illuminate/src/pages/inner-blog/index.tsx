...
<div className="max-w-screen-xl mx-auto">
    ...
    <main className="mt-10">
        ...
        <div className="p-4 absolute bottom-0 left-0 z-20">
          <a href="#"
            className="px-4 py-1 bg-black text-white inline-flex items-center justify-center mb-2">Nutrition</a>
      ...
      <div className="px-4 lg:px-0 mt-12 text-white max-w-screen-md mx-auto text-lg leading-relaxed">
        ...
        <h2 className="text-2xl text-white font-semibold mb-4 mt-4">Uneasy barton seeing remark happen his has</h2>
